...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($username) && !empty($password) && !is_numeric($username)) {
        ...
        //save to database
        $query = "INSERT into student(regno,fullname,username,faculty,email,password,profile_image) VALUES('$regno','$fullname','$username','$faculty','$email','$hashedPassword','$targetFile') ON DUPLICATE KEY UPDATE regno=regno";
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateRegNo(regNo) {
                var regNoPattern = /^[A-Za-z]{2}\d{1,5}\/\d{1,5}\/\d{1,2}$/;
            ...
            document.querySelector('form').addEventListener('submit', function (event) {
                ...
                if (!validateRegNo(regNo)) {
                    alert('Invalid registration number format. Please use the format EB1/12345/12');
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="faculty"><span class="text-danger" style="margin-right: 5px;">*</span>
                                    Faculty: </label>
                                <div class="input-group">
    ...
    <script>
        ...
        function toggleConfirmPassword() {
            ...
            if (confirmPasswordInput.type === 'password') {
                ...
                toggleConfirmIcon.classList.remove('glyphicon-eye-open');
                toggleConfirmIcon.classList.add('glyphicon-eye-close');
            } else {
                confirmPasswordInput.type = 'password';
                toggleConfirmIcon.classList.remove('glyphicon-eye-close');
                toggleConfirmIcon.classList.add('glyphicon-eye-open');
            }
        }

        // Add event listener to the toggle button for confirm password
