...
$query = "SELECT * FROM residentreps ";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="addnonresidentsrep.php">Add Non-Residents Rep</a></li>
            ...
            <div class="col-sm-9">
                <div class="well" style="width:100%;">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $sql = "INSERT INTO residentreps (candidate_no, regno,fullname, username, email, resident, profile_image) 
                            ...
                            <div class="signup-container">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <select id="resident" name="resident" required="">
                                        <option value="malenonresident">Male Non Resident</option>
                                        <option value="femalenonresident">Female non resident</option>
