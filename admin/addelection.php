            ...
            <div class="col-sm-9">
                <div class="well" style="width:100%;">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $sql = "INSERT INTO positions (electionname, startdate, enddate, position) 
                                    VALUES ('$electionname', '$startdate', '$enddate', '$position')";
                    ...
                    <div class="row">
                        <div class="column left">
                            <div class="signup-container">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <label for="electionname">Faculty Name:</label>
                        ...
                        <div class="column right">
                            ...
                            $sql = "SELECT electionname, startdate, enddate,position FROM positions";
