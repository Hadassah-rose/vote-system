                ...
                <div class="well">
                    ...
                    <div style="text-align: center;">
                        ...
                        <p style="font-weight:bolder; font-size:18px; color:darkblue;">Welcome to Chuka University
                            voting System!!! <br><span>We're glad to have you manage the elections</span> </p>
                    ...
                    <div class="card" style="font-size:15px;">
                        ...
                        if (isset ($_SESSION['email'])) {
                            ...
                            $sql = "SELECT  username,fullname, email, profile_image FROM admins WHERE email = ?";
                            ...
                            if ($result) {
                                if ($result->num_rows > 0) {
                                    ...
                                    if ($profileImage) {
                                        echo '<img src="' . $profileImage . '" alt="not available" style="width: 230px; height: 200px;"><br> <br>';
                                    } else {
                                        echo 'No profile image available<br>';
                                    }
