                ...
                <div class="well" style="width:100%;">
                    ...
                    <div class="row">
                        ...
                        <div class="column right">
                            ...
                            $sql = "SELECT candidate_no, regno, fullname, username, email, faculty
                            FROM candidates
                            
                            UNION ALL
                            
                            SELECT candidate_no, regno, fullname, username, email, resident
                            FROM residentreps";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <td>{$row['faculty']}</td>
                                    <td>
                                        <button class='edit-btn' data-candidate-no='{$row['candidate_no']}'>Edit</button>
                                        <button class='delete-btn' data-candidate-no='{$row['candidate_no']}'>Delete</button>
                                    </td>
                                </tr>";
                                    $counter++;
                                }
