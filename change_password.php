...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['login'])) {
        ...
        if (!empty($regno) && !empty($old_password) && !empty($new_password) && !is_numeric($regno)) {
            $query = "SELECT * FROM student WHERE regno = '$regno' AND password = '$old_password' LIMIT 1";
            $result = mysqli_query($con, $query);

            if ($result && mysqli_num_rows($result) > 0) {
                $updateQuery = "UPDATE student SET password = '$new_password' WHERE regno = '$regno'";
                        ...
                        <div class="row">
                            <div class="column left">
                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <input id="regno" type="text" name="regno" placeholder="Your Reg no" required=""
                                        autofocus="">
                                    ...
                                    <button class="btn btn-primary" id="button" name="change_password" type="submit"
                                    value="Change Password">Change Password</button>

                                </form>
                                <ul>
                                    <a href="profile.php" style=" font-weight:600;">Back</a>
                                    <br>
